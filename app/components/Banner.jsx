  ...
  return (
    <div className="pt-[100px] max-[800px]:pt-[80px] " >
      <div
        ...
        className="h-[500px] max-[620px]:h-[300px] bg-cover bg-center flex justify-center items-center"
      >
        <div className="text-center" >
          ...
          <div className="bg-white flex p-[2%] rounded-[25px] font-QRegular mt-[70px] max-[425px]:mt-[35px] max-[425px]:w-[70%] mx-auto" >
