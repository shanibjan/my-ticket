...
setIsSave(true)
  ...
  return (
    <>
      ...
      <div ref={qrCodeRef} className=" bg-white pt-[150px] max-[1000px]:pt-[120px] max-[650px]:pt-[90px] px-[7%] max-[530px]:px-[3%] flex justify-between max-[1250px]:flow-root max-[430px]:relative">
        <div className="w-[65%] max-[1250px]:w-full max-[1250px]:h-[310px] max-[630px]:h-[250px]">
          <div className="flex  p-[2%]   max-[530px]:gap-x-[10px] max-[630px]:h-[250px] gap-x-[30px] shadow-lg ">
            ...
            <div className=" w-[65%] max-[1250px]:w-[70%]  max-[430px]:h-[140px]">
              <div>
                <h1 className=" capitalize text-[25px] max-[630px]:text-[20px] font-QSemi mt-[20px] max-[430px]:mt-[5px] mb-[5px]">
                  {movie}
                </h1>
                <h2 className=" capitalize text-gray-500 text-[15px] font-QRegular">
                  {lang}
                </h2>
        ...
        <div className="w-[30%] max-[1250px]:w-full max-[1250px]:h-full max-[1250px]:my-[10px] shadow-lg  h-[312px]">
          {pay?(<div>
            <h1 className="text-[25px] max-[630px]:text-[20px] font-QSemi text-center">
              Booking Confirmed
            </h1>
            <div  className="flex h-[224px] items-center justify-center">
              <QRCode className="h-[180px]" value={text} size={256} />
            </div>
            <div className=" text-center">
              {isSave?null:(<button
          onClick={handleDownload}
          className="px-4 py-2 bg-[#417AB2] text-white font-QMedium rounded"
        >
          Save Ticket
        </button>)}
        
      </div>
          </div>):(<div className="h-[312px] max-[1250px]:h-full flex items-center">
            <div className="w-full">
              <h1 className="font-QSemi text-center text-[20px] mb-[25px] py-[2%] px-[5%] max-[630px]:text-[18px]">
                Booking Summary
              </h1>
              ...
              <button
                onClick={proceedPay}
                className="bg-[#417AB2] font-QSemi text-white w-[90%] py-[3%] px-[6%] m-[5%]"
              >
                Proceed to pay ₹{" "}
                {seatQuantity.length * 110 + seatQuantity.length * 27.2}
              </button>
