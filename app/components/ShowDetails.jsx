  ...
  <div className="pt-[100px] max-[425px]:pt-[65px] px-[7%] max-[530px]:px-[3%] border-b-[1px] border-b-gray-200 ">
    <div className="py-[2%]" >
      ...
      <div className=" justify-between items-center  ">
        ...
        <div className="flex  font-QMedium max-[425px]:font-QRegular text-[14px] max-[425px]:text-[11px] w-full justify-evenly mt-[25px] mb-[15px] max-[425px]:mt-[13px] max-[425px]:mb-[5px]" >
          <div className="flex items-center " >
            <h1 className="border-[1.5px] max-[425px]:border-[1px] rounded-[4px] h-[20px] w-[20px] border-[#CE567F] mr-[10px] max-[425px]:mr-[5px] max-[425px]:h-[15px] max-[425px]:w-[15px]" ></h1>
            <h1>Available</h1>
          </div>
          <div className="flex items-center" >
            <h1 className="border-[1px] rounded-[5px] h-[20px] w-[20px] bg-gray-300 mr-[10px] max-[425px]:mr-[5px] max-[425px]:h-[15px] max-[425px]:w-[15px]" ></h1>
            <h1>Booked</h1>
          </div>
          <div className="flex items-center" >
            <h1 className="border-[1px] rounded-[5px] h-[20px] w-[20px] bg-[#CE567F] mr-[10px] max-[425px]:mr-[5px] max-[425px]:h-[15px] max-[425px]:w-[15px]" ></h1>
            <h1>Selected</h1>
          </div>
        </div>
