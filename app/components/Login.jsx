...
const Login = ({onDataSend }) => {
    ...
    useEffect(() => {
      ...
      const loginClick = async () => {
        try {
          const res = await axios.post(`https://my-ticket-b9fg.vercel.app/api/auth/login`, {
      ...
      return (
        <div className='flex h-full relative rounded-md' >
            ...
            <div className='w-[50%] max-[620px]:w-full pt-[70px] pb-[10px] flex  justify-center text-center  ' >
                ...
                <h1 className='font-QBold max-[425px]:font-QSemi text-[25px] max-[425px]:text-[18px]  mb-[30px]' >Login</h1>
                {error && (
                <h1 className="mb-[10px] text-[15px] font-QRegular text-red-600">
                  {error}
                </h1>
              )}
                <div className='bg-gray-100 rounded-md max-[425px]:text-[12px] w-[70%] px-[3%] py-[2%] mx-auto flex justify-between items-center font-QRegular mb-[15px]' >
                ...
                <h1 onClick={loginClick} className=" max-[425px]:text-[11px] rounded-md cursor-pointer flex items-center font-QSemi text-[#417AB2] max-[715px]:text-[13px] border-[1px] justify-center mx-auto w-[50%] border-[#417AB2] mt-[30px]  px-[10%] py-[2%]" >Login</h1>
