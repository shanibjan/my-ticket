"use client"
import { faUser, faArrowRight, faCancel, faCross, faLock, faPhone, faXmark } from '@fortawesome/free-solid-svg-icons';
  ...
  return (
    <div className='flex h-full relative' >
        ...
        <div className='w-[50%] max-[620px]:w-full pt-[50px] pb-[10px] flex  justify-center text-center  ' >
            ...
            <h1 className='font-QBold text-[25px] mb-[60px]' >Signup</h1>
            ...
            <div className='bg-gray-100 w-[70%] px-[3%] py-[2%] mx-auto flex justify-evenly items-center font-QRegular mb-[15px]' >
                ...
                <input className='outline-none bg-gray-100 text-gray-500' type="text" placeholder='Username' />
            </div>
            ...
            <h1  className=" cursor-pointer flex items-center font-QSemi text-[#CE567F] max-[715px]:text-[13px] border-[1px] justify-center mx-auto w-[50%] border-[#CE567F] mt-[30px]  px-[10%] py-[2%]" >Signup</h1>
            <div onClick={()=>setGoToLogin(false)}  className='flex justify-between mt-[80px] cursor-pointer text-[14px] w-[60%] items-center font-QMedium text-gray-500 mx-auto' >
